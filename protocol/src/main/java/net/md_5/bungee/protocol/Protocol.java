...
public enum Protocol {
        ...
        GAME {

                {
                        ...
                        TO_CLIENT.registerPacket(
                                        MapData.class,
                                        MapData::new,
                                        map(ProtocolConstants.MINECRAFT_1_8, 0x34),
                                        map(ProtocolConstants.MINECRAFT_1_9, 0x24),
                                        map(ProtocolConstants.MINECRAFT_1_12, 0x25),
                                        map(ProtocolConstants.MINECRAFT_1_13, 0x26),
                                        map(ProtocolConstants.MINECRAFT_1_14, 0x25),
                                        map(ProtocolConstants.MINECRAFT_1_15, 0x26),
                                        map(ProtocolConstants.MINECRAFT_1_16, 0x25),
                                        map(ProtocolConstants.MINECRAFT_1_16_2, 0x24),
                                        map(ProtocolConstants.MINECRAFT_1_17, 0x26),
                                        map(ProtocolConstants.MINECRAFT_1_19, 0x25),
                                        map(ProtocolConstants.MINECRAFT_1_19_1, 0x27),
                                        map(ProtocolConstants.MINECRAFT_1_19_3, 0x26),
                                        map(ProtocolConstants.MINECRAFT_1_19_4, 0x2A),
                                        map(ProtocolConstants.MINECRAFT_1_20_2, 0x2C),
                                        map(ProtocolConstants.MINECRAFT_1_20_5, 0x2E),
                                        map(ProtocolConstants.MINECRAFT_1_21_2, 0x33),
                                        map(ProtocolConstants.MINECRAFT_1_21_5, 0x32),
                                        map(ProtocolConstants.MINECRAFT_1_21_9, 0x37),
                                        map(ProtocolConstants.MINECRAFT_26_1, 0x39));
                        TO_CLIENT.registerPacket(
                                        PlayerPositionAndLook.class,
                                        PlayerPositionAndLook::new,
                                        ...
                                        map(ProtocolConstants.MINECRAFT_1_12_1, 0x30),
                                        ...
                                        map(ProtocolConstants.MINECRAFT_1_17, 0x38),
                                        ...
                                        map(ProtocolConstants.MINECRAFT_1_21_5, 0x47),
                                        map(ProtocolConstants.MINECRAFT_1_21_9, 0x4C),
                        ...
                        TO_CLIENT.registerPacket(
                                        ...
                                        map(ProtocolConstants.MINECRAFT_1_12, 0x17),
                                        map(ProtocolConstants.MINECRAFT_1_12_1, 0x16),
                                        ...
                                        map(ProtocolConstants.MINECRAFT_1_20_2, 0x13),
                                        ...
                                        map(ProtocolConstants.MINECRAFT_1_21_5, 0x1B),
                                        map(ProtocolConstants.MINECRAFT_1_21_9, 0x20),
                                        map(ProtocolConstants.MINECRAFT_26_1, 0x22));
                        TO_CLIENT.registerPacket(
                                        ServerData.class,
                                        ServerData::new,
        ...
        private static class ProtocolData {
                ...
                private final Object2IntMap<Class<? extends DefinedPacket>> packetMap = new Object2IntOpenHashMap<>(
                                MAX_PACKET_ID);
        ...
        public static final class DirectionData {
                ...
                private void registerPacket(Class<? extends DefinedPacket> packetClass,
                                Supplier<? extends DefinedPacket> constructor, RegisterType registerType,
                ...
                int getId(Class<? extends DefinedPacket> packet, int version) {
                        ...
                        Preconditions.checkArgument(packetId >= 0,
                                        ...
                                        packet, protocolPhase, direction, version); // Waterfall - add version
